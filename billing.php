...
while ($row = $result->fetch_assoc()) {
  ...
  echo '<tr style="color: #fff; "> 
    ...
    Hello,<?php echo $user_data['user_name']; ?>.  Given below is the cost collected by your properties in the last one month</div>
<!-- HTML !-->
...
<a href="zipcode_mov.php">
<button style="background-color: transparent;color:white;padding: 15px 32px; text-align:center;display:inline-block;font: size 16px;margin: 4px 2px;" >Zipcode Pricing Behaviour</button>
</a>
</html>